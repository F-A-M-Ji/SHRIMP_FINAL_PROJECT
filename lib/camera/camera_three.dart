...
class MyPreview extends StatefulWidget {
  ...
  @override
  State<MyPreview> createState() => _MyPreviewState();
}

class _MyPreviewState extends State<MyPreview> {
          ...
          children: [
            Center(
              child: Image.file(
                ...
                //fit: BoxFit.cover,
                fit: BoxFit.fill,
                width: widget.imageWidth, // กำหนดความกว้างของรูปภาพ
                height: widget.imageHeight, // กำหนดความสูงของรูปภาพ
              ),
            ),
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    if (widget.name_scales == 2) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ALLSKING()),
                      );
                    } else if (widget.name_scales == 1) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Timecafe_White()),
                      );
                    } else if (widget.name_scales == 3) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
